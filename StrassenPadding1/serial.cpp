...
vector<vector<int>> strassen(vector<vector<int>> &A, vector<vector<int>> &B)
{
    ...
    vector<vector<int>> P1 = strassen(A11,B11);
    vector<vector<int>> P2 = strassen(A12,B21);
    vector<vector<int>> P3 = strassen(S1,T1);
    vector<vector<int>> P4 = strassen(S2,T2);
    vector<vector<int>> P5 = strassen(S3,T3);
    vector<vector<int>> P6 = strassen(S4,B22);
    vector<vector<int>> P7 = strassen(A22,T4);
