...
def compileFile(file):
    ...
    out, err = Popen('g++ -o '+file_name+' '+file+' -lm -fopenmp -std=c++11', stdout=PIPE, stderr=PIPE, shell=True).communicate()
    out = out.strip()
    err = err.strip()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print compileFile('serial.cpp')
        print compileFile('parallel.cpp')
